...
@if(!empty($appSettings['whatsapp_float']))
<a href="https://wa.me/{{ $appSettings['whatsapp_float'] }}?text={{ urlencode($appSettings['whatsapp_float_text'] ?? '') }}"
   target="_blank" rel="noopener" aria-label="Chat WhatsApp"
   style="position:fixed;right:22px;bottom:22px;z-index:9999;width:60px;height:60px;border-radius:50%;background:#25D366;display:flex;align-items:center;justify-content:center;box-shadow:0 6px 20px rgba(37,211,102,.45);transition:transform .2s ease,box-shadow .2s ease;"
   onmouseover="this.style.transform='scale(1.08)';this.style.boxShadow='0 8px 26px rgba(37,211,102,.55)';"
   onmouseout="this.style.transform='scale(1)';this.style.boxShadow='0 6px 20px rgba(37,211,102,.45)';">
    <svg viewBox="0 0 32 32" width="34" height="34" fill="#fff" xmlns="http://www.w3.org/2000/svg">
        <path d="M16.04 3C9.4 3 4 8.4 4 15.04c0 2.13.56 4.2 1.62 6.04L4 29l8.13-1.58a12.02 12.02 0 0 0 3.9.66h.01C22.68 28.08 28 22.68 28 16.04 28 8.4 22.68 3 16.04 3Zm0 21.93c-1.2 0-2.38-.21-3.5-.62l-.25-.1-4.83.94.96-4.7-.16-.26a9.97 9.97 0 0 1-1.53-5.32c0-5.5 4.48-9.97 9.99-9.97 2.67 0 5.18 1.04 7.06 2.93a9.9 9.9 0 0 1 2.92 7.05c0 5.5-4.48 9.95-9.99 9.95Zm5.48-7.46c-.3-.15-1.77-.87-2.05-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.94 1.17-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.48-.89-.79-1.49-1.77-1.66-2.07-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.62-.92-2.22-.24-.58-.49-.5-.67-.51l-.57-.01c-.2 0-.52.07-.79.37-.27.3-1.04 1.02-1.04 2.48 0 1.46 1.06 2.87 1.21 3.07.15.2 2.09 3.2 5.07 4.49.71.3 1.26.49 1.69.62.71.23 1.36.2 1.87.12.57-.08 1.77-.72 2.02-1.42.25-.7.25-1.29.17-1.42-.07-.12-.27-.2-.57-.35Z"/>
    </svg>
</a>
@endif
</body>
