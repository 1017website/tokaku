                ...
                <div style="display:flex;flex-direction:column;gap:16px;">
                    ...
                    <div style="padding:16px 0;border-top:1px solid #f8fafc;">
                        ...
                        <div>
                            ...
                            <input type="text" inputmode="numeric" name="initial_capital" value="{{ old('initial_capital', (int) ($tenant->initial_capital ?? 0)) }}" class="form-input input-rupiah" placeholder="contoh: 10000000">
