    ...
    <div class="table-responsive overflow-x-auto">
        <table style="width:100%;border-collapse:collapse;min-width:500px;">
            ...
            <tr style="border-bottom:1px solid #f8fafc;transition:background 0.1s;" onmouseover="this.style.background='#fafafa'" onmouseout="this.style.background='#fff'">
                ...
                <td data-label="Status" style="padding:13px 18px;text-align:center;">
                    @if($u->is_active)
                ...
                <td data-label="Bergabung" style="padding:13px 18px;font-size:13px;color:#64748b;">{{ $u->created_at->format('d M Y') }}</td>
            </tr>
            @empty
            <tr><td data-empty colspan="5" style="padding:50px;text-align:center;color:#94a3b8;font-size:13.5px;">Tidak ada user.</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
