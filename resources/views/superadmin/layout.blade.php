...
<head>
    ...
    <script>tailwind.config={theme:{extend:{fontFamily:{sans:['Inter','sans-serif']},colors:{primary:{50:'#f0fdf6',100:'#dcfce9',700:'#0F6E56',800:'#085041'}}}}}</script>
    <style>
        *{-webkit-font-smoothing:antialiased;}
        ...
        .form-input{width:100%;border:1.5px solid #e2e8f0;border-radius:10px;padding:10px 14px;font-size:13.5px;font-family:Inter,sans-serif;outline:none;background:#fafafa;color:#111827;transition:all 0.15s;box-sizing:border-box;}
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="sa-sidebar w-60 bg-white border-r border-gray-100 flex flex-col flex-shrink-0" id="saSidebar">
        <div style="padding:16px 20px;border-bottom:1px solid #f1f5f9;display:flex;align-items:center;justify-content:space-between;">
            <div style="display:flex;align-items:center;gap:10px;">
                <div style="width:32px;height:32px;background:#0F6E56;border-radius:10px;display:flex;align-items:center;justify-content:center;">
                    <svg width="15" height="15" viewBox="0 0 18 18" fill="none"><path d="M3 5h12M3 9h8M3 13h5" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>
                </div>
                <div>
                    <p style="font-size:14px;font-weight:700;color:#0F6E56;letter-spacing:-0.3px;">Tokaku</p>
                    <p style="font-size:11px;color:#9ca3af;">Super Admin</p>
                </div>
            </div>
            <button onclick="closeSA()" class="lg:hidden" style="background:none;border:none;cursor:pointer;color:#9ca3af;padding:4px;">
        ...
        <div style="padding:10px;border-top:1px solid #f1f5f9;">
            <div style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;" class="group hover:bg-gray-50">
                ...
                <form method="POST" action="{{ route('logout') }}">@csrf
                    <button type="submit" style="background:none;border:none;cursor:pointer;color:#d1d5db;padding:0;" onmouseover="this.style.color='#f43f5e'" onmouseout="this.style.color='#d1d5db'">
    ...
    <main class="flex-1 overflow-y-auto min-w-0">
        <header style="background:#fff;border-bottom:1px solid #f1f5f9;padding:14px 20px;display:flex;align-items:center;justify-content:space-between;position:sticky;top:0;z-index:20;">
            <div style="display:flex;align-items:center;gap:10px;">
                <button onclick="openSA()" class="lg:hidden" style="background:none;border:none;cursor:pointer;color:#6b7280;padding:4px;margin-left:-4px;">
